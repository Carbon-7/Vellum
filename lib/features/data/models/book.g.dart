...
void _bookSerialize(
  ...
  writer.writeLong(offsets[6], object.lastReadPosition);
...
Book _bookDeserialize(
  ...
  object.id = id;
  object.lastReadPosition = reader.readLong(offsets[6]);
...
extension BookQueryWhere on QueryBuilder<Book, Book, QWhereClause> {
  ...
  QueryBuilder<Book, Book, QAfterWhereClause> genreEqualTo(String genre) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'genre',
        value: [genre],
  ...
  QueryBuilder<Book, Book, QAfterWhereClause> genreNotEqualTo(String genre) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
